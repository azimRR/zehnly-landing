          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            ...
            <div className="flex-1 text-center lg:text-left">
              <h1
                ...
                data-aos="fade-up"
              >
                Learn English Through Games That Actually Work
              </h1>
              <p
                ...
                data-aos-delay={200}
              >
                Zehnly AI turns English learning into an addictive gaming experience. 6 unique games, AI-powered difficulty, and speaking practice that gets you fluent faster.
              </p>
              ...
              <div className="mt-10 flex items-center justify-center lg:justify-start gap-4" data-aos="fade-up" data-aos-delay={600}>
                ...
                <p className="text-purple-200/50 text-sm font-medium">Trusted by 30,000+ learners</p>
              </div>
            </div>
