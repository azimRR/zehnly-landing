            ...
            >
              <div className="relative z-10 flex flex-col gap-3">
                <div className="flex gap-0.5">
                  {[...Array(5)].map((_, j) => (
                    <svg key={j} className={`w-4 h-4 fill-current ${j < t_item.stars ? "text-yellow-400" : "text-gray-700"}`} viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" /></svg>
                  ))}
                </div>
                <p className="text-sm text-purple-200/65">&ldquo;{t_item.content}&rdquo;</p>
                <div className="flex items-center gap-3 pt-1">
                  ...
                  <div>
                    <div className="text-sm font-medium text-gray-200">{t_item.name}</div>
                    <div className="text-xs text-purple-200/40">{t_item.country}</div>
                  </div>
                </div>
              </div>
            </article>
