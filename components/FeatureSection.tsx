...
export const FeatureSection = () => {
  ...
  const features = [
    { id: 1, title: t("flashcards.title"), description: t("flashcards.description"), icon: Layers, color: "yellow", delay: 0, lightImages: ["/assets/FeaturesExtended/Flashcards(light)/Flashcards.jpg","/assets/FeaturesExtended/Flashcards(light)/Flashcards-1.jpg","/assets/FeaturesExtended/Flashcards(light)/Flashcards-2.jpg","/assets/FeaturesExtended/Flashcards(light)/Flashcards-3.jpg","/assets/FeaturesExtended/Flashcards(light)/Flashcards-4.jpg","/assets/FeaturesExtended/Flashcards(light)/Flashcards-5.jpg"] },
    { id: 2, title: t("oddOneOut.title"), description: t("oddOneOut.description"), icon: HelpCircle, color: "purple", delay: 0.1, lightImages: ["/assets/FeaturesExtended/Odd1Out(light)/ODD 1 OUT.png","/assets/FeaturesExtended/Odd1Out(light)/ODD 1 OUT.jpg","/assets/FeaturesExtended/Odd1Out(light)/ODD 1 OUT-1.png","/assets/FeaturesExtended/Odd1Out(light)/ODD 1 OUT-1.jpg","/assets/FeaturesExtended/Odd1Out(light)/ODD 1 OUT-2.jpg"] },
    { id: 3, title: t("connections.title"), description: t("connections.description"), icon: Sword, color: "red", delay: 0.2, lightImages: ["/assets/FeaturesExtended/Connections/Game/Connections.jpg","/assets/FeaturesExtended/Connections/Game/Connections-1.jpg","/assets/FeaturesExtended/Connections/Game/Connections-2.jpg","/assets/FeaturesExtended/Connections/Game/Connections-3.jpg"] },
    { id: 4, title: t("fourPics.title"), description: t("fourPics.description"), icon: ImageIcon, color: "green", delay: 0.3, lightImages: ["/assets/FeaturesExtended/4Pics1Word(light)/4 PICS 1 WORD.png","/assets/FeaturesExtended/4Pics1Word(light)/4 PICS 1 WORD.jpg","/assets/FeaturesExtended/4Pics1Word(light)/4 PICS 1 WORD-1.png","/assets/FeaturesExtended/4Pics1Word(light)/4 PICS 1 WORD-1.jpg"] },
    { id: 5, title: t("squares.title"), description: t("squares.description"), icon: Grid3x3, color: "yellow", delay: 0.4, lightImages: ["/assets/FeaturesExtended/Squares/Game.jpg","/assets/FeaturesExtended/Squares/Game-1.jpg","/assets/FeaturesExtended/Squares/Game-2.jpg","/assets/FeaturesExtended/Squares/Game-3.jpg"] },
    { id: 6, title: t("wordBattle.title"), description: t("wordBattle.description"), icon: Swords, color: "red", delay: 0.5, lightImages: ["/assets/FeaturesExtended/WordBattle(light)/Word Battle.png","/assets/FeaturesExtended/WordBattle(light)/Word Battle.jpg","/assets/FeaturesExtended/WordBattle(light)/Word Battle-1.png","/assets/FeaturesExtended/WordBattle(light)/Word Battle-1.jpg"] },
  ];
        ...
        <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,--theme(--color-slate-400/.25),transparent)1] md:py-20">
          ...
          <div className="mx-auto grid max-w-sm gap-8 sm:max-w-none sm:grid-cols-2 md:gap-x-14 md:gap-y-12 lg:grid-cols-3">
            {features.map((feature) => (
              <FeatureCard key={feature.id} {...feature} tapToPreview={t("tapToPreview")} />
            ))}
          </div>
        </div>
      </div>
